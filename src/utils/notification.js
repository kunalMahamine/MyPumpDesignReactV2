...
const Notification = ({ message }) => {
  return message ? (
    ...
    //   {message}
    // </div>
    <div className="alert alert-warning d-flex align-items-center p-1" role="alert">
      {/* <svg class="bi flex-shrink-0 me-2" width="24" height="24">
        <use xlink:href="#exclamation-triangle-fill" />
      </svg> */}
          <svg className="icon-32 pe-2" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
