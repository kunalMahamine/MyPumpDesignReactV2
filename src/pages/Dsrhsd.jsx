...
function Dsrhsd() {
  ...
  const fetchData = async (from, to) => {
    ...
    try {
      ...
      console.error('Error fetching DSRHSD Report:', error);
      setError('Failed to load DSRHSD Report. Please try again later.');
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className="card">
                <div className="card-header d-flex justify-content-between">
                  <div className="header-title">
                    <h4 className="card-title">DSR HSD (Diesel)</h4>
                  </div>
                        ...
                        <thead>
                          <tr>
                            ...
                            {pumpIds.map((pumpId, index) => (
                              <th key={pumpId}>Clo Reading P{index + 3}</th>
                            ))}
                            <th>Dispensed</th>
                            <th>Test</th>
                            <th>Sold</th>
